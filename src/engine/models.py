...
BLOCK_TYPES = {
    ...
    "win_wait_control":    {"label": "等待控件出现",     "category": "窗口控件", "color": "#F59E0B", "icon": "⏱️"},
    "win_find_control":    {"label": "查找控件",         "category": "窗口控件", "color": "#F59E0B", "icon": "🔍"},
    "win_click_offset":    {"label": "窗口坐标偏移点击", "category": "窗口控件", "color": "#F59E0B", "icon": "🎯"},
    "win_find_image":      {"label": "窗口查找图片",     "category": "窗口控件", "color": "#F59E0B", "icon": "🖼️"},
    "win_click_image":     {"label": "窗口点击图片",     "category": "窗口控件", "color": "#F59E0B", "icon": "🖱️"},
}
...
BLOCK_PARAMS: Dict[str, Dict[str, Any]] = {
    ...
    "win_click_control": {
        "window_title":  {"type": "window_picker", "label": "窗口标题(支持*通配符)", "default": "",
                          "placeholder": "目标窗口的标题，支持 * 通配符"},
        "class_name":    {"type": "window_class_picker", "label": "窗口类名(可选，精确匹配)", "default": "",
                          "placeholder": "如 Notepad, Chrome_WidgetWin_1，自动识别或手动填写"},
        "process_name":  {"type": "process_picker", "label": "进程名(可选)", "default": "",
                          "placeholder": "如 notepad.exe, chrome.exe"},
    ...
    "win_find_control": {
        ...
        "control_type":  {"type": "select", "label": "控件类型", "default": "Button",
                          ...
                          "option_labels": ["按钮", "文本框", "下拉框", "列表框", "复选框",
                                            "单选按钮", "菜单项", "静态文本", "任意类型"]},
        "timeout":       {"type": "number_or_var", "label": "超时秒数", "default": 5},
        "save_to":       {"type": "text", "label": "控件信息存入变量(可选)", "default": "ctrl_info",
                          "placeholder": "保存控件句柄或信息的变量名"},
        "on_not_found":  {"type": "select", "label": "未找到时", "default": "continue",
                          "options": ["continue", "stop_task"],
                          "option_labels": ["继续执行(变量置空)", "停止任务"]},
    },
    "win_click_offset": {
        "window_title":  {"type": "window_picker", "label": "目标窗口标题(支持*通配符)", "default": "",
                          "placeholder": "目标窗口的标题，支持 * 通配符"},
        "class_name":    {"type": "window_class_picker", "label": "窗口类名(可选，精确匹配)", "default": "",
                          "placeholder": "如 Notepad, Chrome_WidgetWin_1 等，自动识别或手动填写"},
        "process_name":  {"type": "process_picker", "label": "进程名(可选)", "default": "",
                          "placeholder": "如 notepad.exe, chrome.exe 等"},
        "offset_x":      {"type": "number_or_var", "label": "X 偏移(像素，相对窗口左上角)", "default": 0},
        "offset_y":      {"type": "number_or_var", "label": "Y 偏移(像素，相对窗口左上角)", "default": 0},
        "button":        {"type": "select", "label": "鼠标键", "default": "left",
                          "options": ["left", "right", "middle"],
                          "option_labels": ["左键", "右键", "中键(滚轮)"]},
        "clicks":        {"type": "number_or_var", "label": "点击次数", "default": 1},
        "move_first":    {"type": "bool", "label": "先移动鼠标再点击", "default": True},
        "timeout":       {"type": "number_or_var", "label": "查找窗口超时秒数", "default": 5},
    },
    # ── 窗口图片识别（在指定窗口截图内查找图片，不依赖屏幕坐标）──
    "win_find_image": {
        "window_title":  {"type": "window_picker", "label": "目标窗口标题(支持*通配符)", "default": "",
                          "placeholder": "目标窗口的标题，支持 * 通配符"},
        "class_name":    {"type": "window_class_picker", "label": "窗口类名(可选)", "default": "",
                          "placeholder": "精确匹配窗口类名，如 Chrome_WidgetWin_1"},
        "process_name":  {"type": "process_picker", "label": "进程名(可选)", "default": "",
                          "placeholder": "如 chrome.exe, notepad.exe"},
        "image_path":    {"type": "file_picker", "label": "目标图片路径", "default": "",
                          "placeholder": "截取目标区域的截图，支持 PNG/JPG"},
        "confidence":    {"type": "number_or_var", "label": "匹配精度(0.1-1.0)", "default": 0.8},
        "timeout":       {"type": "number_or_var", "label": "查找窗口超时秒数", "default": 5},
        "save_x":        {"type": "text", "label": "找到时：X坐标存入变量(相对窗口)", "default": "",
                          "placeholder": "变量名，如 img_x"},
        "save_y":        {"type": "text", "label": "找到时：Y坐标存入变量(相对窗口)", "default": "",
                          "placeholder": "变量名，如 img_y"},
        "on_not_found":  {"type": "select", "label": "未找到时", "default": "continue",
                          "options": ["continue", "stop_task"],
                          "option_labels": ["继续执行(变量置空)", "停止任务"]},
    },
    "win_click_image": {
        ...
        "button":        {"type": "select", "label": "鼠标键", "default": "left",
                          ...
                          "option_labels": ["左键", "右键", "中键(滚轮)"]},
        "clicks":        {"type": "number_or_var", "label": "点击次数", "default": 1},
        "offset_x":      {"type": "number_or_var", "label": "点击X偏移(像素，相对图片中心)", "default": 0},
        "offset_y":      {"type": "number_or_var", "label": "点击Y偏移(像素，相对图片中心)", "default": 0},
        "timeout":       {"type": "number_or_var", "label": "查找窗口超时秒数", "default": 5},
        "on_not_found":  {"type": "select", "label": "未找到时", "default": "continue",
                          "options": ["continue", "stop_task"],
                          "option_labels": ["继续执行", "停止任务"]},
...
class AppConfig:
    ...
    theme_pack_path: str = ""          # 已加载的整合包路径（空=未加载）
    # 日志
